...
function OurTeam() {
  return (
    <div className="h-max w-full bg-gray-50 overflow-hidden">
        ...
        <div className="container px-5 py-8 mx-auto">
          <div className="flex flex-col text-center w-full mb-10">
            ...
            <p className="lg:w-2/3 mx-auto leading-relaxed text-base">
              This is our developer team, we are the ideal partners for your
              products or services to enter the digital world with the best
              company. We accompany you so that your business grows on the
              Internet.
            </p>
          </div>
          ...
          <div className="flex flex-wrap my-1 mx-0">
            ...
            {/* <div className="p-2 lg:w-1/3 md:w-1/2 w-full">
                  <div className="h-full flex items-center border-gray-200 border p-4 rounded-lg transition duration-300 hover:shadow-md hover:bg-[#FFD700]">
                    <Image
                      alt="team"
                      className="w-16 h-16 bg-gray-50 object-cover object-center flex-shrink-0 border-solid shadow-md shadow-[#555555] rounded-full mr-4 transition duration-300 hover:scale-110"
                      src={person_9}
                      width={"100"}
                      height={"100"}
                    />
      ...
      <section className="bg-neutral-50">
        <div className=" px-5 py-12 mx-auto lg:px-16">
          ...
          <div className="mx-auto text-center">
            <div className="grid grid-cols-2 gap-4 mx-auto lg:grid-cols-2 h500:grid-cols-1">
              <div>
                <img
                  className="h-12 mx-auto lg:h-12"
