...
export default async function CarDetail({ params }: ParamsType) {
  ...
  return (
    <div>
      ...
      <section className='w-9/12 mx-auto'>
        <div className='grid grid-cols-2 items-center m-8'>
          ...
          <div>
            ...
            <span className='first-letter:text-left text-[#332F2E] leading-14 text-xl uppercase mb-3'>{car.presentacion}</span>
            <p className='text-xs font-bold uppercase tracking-wide mt-4 mb-0'>Precio</p>
      ...
      <h2 className='text-4xl font-semibold p-4 text-center'>Caracteristicas Principales</h2>
        ...
        <div className='p-4 flex items-center flex-col'>
          <p className='font-semibold text-center'>
            <Image
              ...
              height={50}
              priority
            />{car.fichaTecnica?.transmision}</p>
          <p>Transmisión</p>
        </div>
        <div className='p-4 flex items-center flex-col'>
          <p className='font-semibold text-center'>
