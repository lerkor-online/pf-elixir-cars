...
const MakeCarousel: React.FC = () => {
  const slides = [
    {
      url: 'https://res.cloudinary.com/doobpmn9q/image/upload/v1689447954/E-comerce-Elixircars/Renault%20NEW%20KWID%20ZEN%201.0%202023/chrome_4imTEYYeGZ_w0gkat.png',
    },
    {
