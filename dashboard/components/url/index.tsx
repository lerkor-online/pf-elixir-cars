              ...
              <tr className="flex justify-between border-b border-gray-200 py-1 w-full">
                <td className="w-[30%] flex justify-start">
                  <div className="flex items-center gap-x-2">
                    ...
                    <div>
                      <p className="lg:text-xs xl:text-sm">Comprar autos</p>
                    </div>
                  </div>
                </td>
                <td className="w-[30%] flex justify-start">
                  <div className="flex items-center">
                  <DateField selectedDate={selectedDate} onChange={handleDateChange} />
                  </div>
                </td>
                <td className="w-[30%] flex justify-start]">
                  {/* <div>
              ...
              <tr className="flex justify-between border-b border-gray-200 py-1 w-full">
                <td className="w-[30%] flex justify-start">
                  <div className="flex items-center gap-x-2">
                    ...
                    <div>
                      <p className="lg:text-xs xl:text-sm">Vender autos</p>
                    </div>
                  </div>
                </td>
                <td className="w-[30%] flex justify-start">
